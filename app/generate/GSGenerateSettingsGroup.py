...
from groupselect import Algorithm, AllocatorResult, allocate_pandas
from GSAppFieldMode import GSAppFieldMode, map_field_modes
...
class GSGenerateSettingsGroup(QGroupBox):
    ...
    def _create_settings_group(self):
        ...
        # Set visibility status based on sliders panel.
        is_hermes = (
    ...
    def _button_clicked(self):
        ...
        if sender == self._btn_add_manual:
            try:
                ...
                allocatables = model.get_allocatables()
            ...
            try:
                ...
                diversity_score = (
                    allocation_result.ensemble.calc_diversity_score(
                        people_data
                    )
                )
                meeting_score = (
                    allocation_result.ensemble.calc_meeting_norm_score()
                )
