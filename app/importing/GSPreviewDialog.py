"""Dialog for previewing and configuring an import before it is applied."""
...
class GSPreviewDialog(QDialog):
    """Dialog to preview imported data and configure columns and ranges."""
    ...
    def __init__(self, parent: QWidget, data_handle: DataImportHandle):
        """Initialise the dialog, load the preview data, and build the UI."""
        # super constructor
    ...
    def data(self) -> pd.DataFrame:
        """The currently loaded preview data."""
        return self._data

    @property
    def file_config(self) -> dict:
        """The current file-reading configuration."""
    ...
    def display(cls, parent: QWidget, data_handle: DataImportHandle):
        """Show the dialog and, if accepted, apply config to data_handle."""
