"""Table view over the raw participants' data, with a column context menu."""
...
class GSParticipantsDataSubtab(QTableView):
    """Subtab showing the imported data, with rename/disable per column."""

    def __init__(self, ctx: AppContext):
        """Initialise the view and wire up the header context menu."""
